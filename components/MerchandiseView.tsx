              ...
              >
                ...
                <div>
                  <div className="relative aspect-[4/5] w-full overflow-hidden bg-neutral-100 mb-4 flex items-center justify-center p-2 rounded-2xl">
                    <img src={product.images?.[0] || product.imageUrl || "https://images.unsplash.com/photo-1521572267360-ee0c2909d518"} alt={product.name} loading="lazy" decoding="async" style={{ imageRendering: "auto" }} className="object-cover w-full h-full mix-blend-multiply group-hover:scale-110 transition-transform duration-700 ease-in-out rounded-xl" />
                  </div>
